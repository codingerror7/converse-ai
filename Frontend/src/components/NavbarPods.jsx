  ...
  return (
    <div className="absolute top-0 inset-x-0 z-30 flex items-start justify-between pointer-events-none w-full">
      ...
      <motion.div
        ...
        className="pointer-events-auto flex items-center gap-2 sm:gap-4 bg-[#06090D] px-3 sm:px-6 py-2 sm:py-3 rounded-br-[18px] sm:rounded-br-[26px] border-r border-b border-[#1E2933] shadow-[0_12px_30px_rgba(6,9,13,0.95)] backdrop-blur-xl"
      >
      ...
      <motion.div
        ...
        className="pointer-events-auto flex items-center gap-1.5 sm:gap-3 bg-[#06090D] px-3 sm:px-6 py-2 sm:py-3 rounded-bl-[18px] sm:rounded-bl-[26px] border-l border-b border-[#1E2933] shadow-[0_12px_30px_rgba(6,9,13,0.95)] backdrop-blur-xl"
      >
        <Link
          href="/Business"
          className="hidden xs:inline-block text-[11px] sm:text-[13px] font-medium text-[#94A3B8] hover:text-[#F1F5F9] px-1.5 sm:px-2 py-1 transition-colors duration-200"
        >
          Start
        </Link>
