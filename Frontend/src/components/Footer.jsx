...
export default function Footer() {
  return (
    <footer className="w-full bg-[#030303] border-t border-white/[0.06] pt-16 sm:pt-20 pb-8 sm:pb-10 relative overflow-hidden select-none">
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pb-12 sm:pb-14 border-b border-white/[0.06]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 py-10 sm:py-12 max-w-2xl">
          
          {/* Column 1: Product */}
          <div className="space-y-3">
            <h4 className="text-[11px] font-mono uppercase tracking-[0.14em] text-[#71717A] font-semibold">
              PRODUCT
            </h4>
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#71717A]">
